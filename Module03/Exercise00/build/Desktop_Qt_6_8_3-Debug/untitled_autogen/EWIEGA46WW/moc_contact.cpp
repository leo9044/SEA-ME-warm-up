...
static constexpr auto qt_meta_stringdata_ZN7ContactE = QtMocHelpers::stringData(
    "Contact"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7ContactE[] = {
...
Q_CONSTINIT const QMetaObject Contact::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7ContactE.offsetsAndSizes,
    qt_meta_data_ZN7ContactE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7ContactE_t,
        // Q_OBJECT / Q_GADGET
...
void *Contact::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7ContactE.stringdata0))
